    ...
    <div className="py-24 px-4 md:px-8 lg:px-16 xl:px-26 2xl:px-64 bg-gray-100 text-sm mt-24">
      ...
      <div className="flex flex-col md:flex-row justify-between gap-24">
        ...
        <div className="w-full md:w-1/2 lg:w-1/4 flex flex-col gap-8">
          <Link href="/">
            <div className="text-2xl tracking-wide">~NATA~</div>
          </Link>
          <p className="">Staffordshire, Penkridge, POSTCode, United Kingdom</p>
          <span className="font-semibold">example@gamil.com</span>
          <span className="font-semibold">+44 4525 654 123</span>
